/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8f1a5b9e4ea0007a68bf2e33a039a193)
// Runtime types generated with workerd@1.20250803.0 2025-08-03 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		LATEST_NOTICIERO_ST: KVNamespace;
		...
		AUDIO_GENERATOR: DurableObjectNamespace<import("./src/index").DurableAudioGenerator>;
		NOTICIEROS_STORAGE: R2Bucket;
		DB: D1Database;
		AUDIO_GEN_WORKFLOW: Workflow;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "GEMINI_API_KEY" | "JWT_SECRET" | "GCP" | "AUDIO_BUCKET_NAME" | "GCP_PROJECT_NAME">> {}
}
